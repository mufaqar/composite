...
const Shop = () => {
    ...
    return (
        <section className="pt-24 pb-12 bg-background">
            {/* Heading + Read More */}
            <HeadingSection title="Shop Composite Decking Online" desc="CompositeWarehouse – Your one-stop-shop for all kinds of composite materials. You will buy Eco-friendly and low maintenance composite materials for your projects."
            readMore />
